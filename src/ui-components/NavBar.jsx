...
export default function NavBar(props) {
  ...
  const logoFourZeroFourSixFiveZeroZeroOnClick = useNavigateAction({
    type: "url",
    url: "/",
  });
  const bookFlightOnClick = useNavigateAction({ type: "url", url: "/" });
  const bookHotelOnClick = useNavigateAction({ type: "url", url: "/hotel" });
  const exploreOnClick = useNavigateAction({ type: "url", url: "/explore" });
  const pastBookingsOnClick = useNavigateAction({
    type: "url",
    url: "/history",
  });
  return (
    ...
    >
      <Flex
        ...
        onClick={() => {
          logoFourZeroFourSixFiveZeroZeroOnClick();
        }}
        {...getOverrideProps(overrides, "Logo4046500")}
      >
        <Icon
          width="18px"
          height="18px"
        ...
        <Text
          ...
          whiteSpace="pre-wrap"
          children="Wanderlust"
          {...getOverrideProps(overrides, "Logo4046502")}
        ></Text>
      </Flex>
      <Flex
        gap="40px"
        ...
        position="relative"
        padding="0px 0px 0px 0px"
        {...getOverrideProps(overrides, "Frame 3214046503")}
      >
        <Text
          fontFamily="Inter"
          fontSize="16px"
          ...
          {...getOverrideProps(overrides, "Book Flight")}
        ></Text>
        <Text
          fontFamily="Inter"
          fontSize="16px"
          ...
          {...getOverrideProps(overrides, "Book Hotel")}
        ></Text>
        <Text
          fontFamily="Inter"
          fontSize="16px"
        ...
        <Text
          ...
          {...getOverrideProps(overrides, "Past Bookings")}
        ></Text>
      </Flex>
      <Flex
        gap="32px"
        ...
        position="relative"
        padding="0px 0px 0px 0px"
        {...getOverrideProps(overrides, "Frame 3214046508")}
      ></Flex>
      <Flex
        gap="0"
        direction="row"
