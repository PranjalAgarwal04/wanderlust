...
export declare type NavBarOldOverridesProps = {
    NavBarOld?: PrimitiveOverrideProps<FlexProps>;
...
export declare type NavBarOldProps = React.PropsWithChildren<Partial<FlexProps> & {
    overrides?: NavBarOldOverridesProps | undefined | null;
}>;
export default function NavBarOld(props: NavBarOldProps): React.ReactElement;
